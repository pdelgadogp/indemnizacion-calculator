        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <label className="bg-white rounded-xl border border-zinc-200 px-4 py-3 focus-within:border-zinc-300 focus-within:shadow-sm transition-all">
            ...
            <input
              ...
              className="w-full text-[15px] font-medium text-zinc-900 bg-transparent outline-none border border-zinc-200 rounded-md px-2 py-0.5 focus:border-zinc-300"
            />
          </label>
        ...
        {results ? (
          <>
            <div className="grid grid-cols-3 text-center text-xs bg-white rounded-xl border border-zinc-200 divide-x divide-zinc-100 py-2.5">
              ...
              <span className="text-zinc-500">Meses computables <strong className="text-zinc-900 ml-1">{results.monthsWorked.toLocaleString("es-ES")}</strong></span>
            </div>
