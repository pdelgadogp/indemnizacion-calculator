    ...
    <main className="h-screen overflow-y-auto bg-zinc-50 p-6 font-[family-name:var(--font-geist-sans),system-ui,sans-serif] select-none">
      <div className="max-w-2xl lg:max-w-3xl mx-auto flex flex-col gap-5 pb-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          <label className="bg-white rounded-xl border border-zinc-200 px-2.5 py-3 focus-within:border-zinc-300 focus-within:shadow-sm transition-all overflow-hidden">
...
className="w-full min-w-0 text-xs font-medium text-zinc-900 bg-transparent outline-none truncate border border-zinc-200 rounded-md px-1 py-0.5"
              />
          </label>
